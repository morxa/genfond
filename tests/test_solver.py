...
def test_solver_two_conflicting_actions():
    ...
    assert solver.solution['selected'] == {'f', 'g', 'dead'}
    assert solver.solution['trans_delta'] == {(0, 0, 0, 'f', 0), (0, 0, 0, 'g', 0), (0, 0, 0, 'dead', 0),
                                              (0, 0, 1, 'f', 1), (0, 0, 1, 'g', 0), (0, 0, 1, 'dead', 0),
                                              (0, 0, 2, 'f', 1), (0, 0, 2, 'g', 0), (0, 0, 2, 'dead', 1),
                                              (0, 1, 3, 'f', 1), (0, 1, 3, 'g', 0), (0, 1, 3, 'dead', 0),
                                              (0, 3, 4, 'f', 1), (0, 3, 4, 'g', 1), (0, 3, 4, 'dead', 0)}
