(define (problem p11)
  ...
  (:objects n0 - location
            ...
            nb1 nb2 nb3 nb4 nb5 nb6 nb7 nb8 nb9 nb10 nb11 nb12 nb13 nb14 nb15 nb16 nb17 nb18 nb19 nb20 nb21 - location
            ng - location
  ...
  (:init (vehicle-at n0)
         ...
         (road nb17 nb18) (road nb18 nb17)
         (road nb18 nb19) (road nb19 nb18)
         (road nb19 nb20) (road nb20 nb19)
         (road nb20 nb21) (road nb21 nb20)
         (road nb21 ng) (road ng nb21)
